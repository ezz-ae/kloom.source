...
export default function PrivacyPage() {
  return (
    <>
      ...
      <p>
        {SITE.name} is built to know as little about you as possible. There is no signup form, no email
      ...
      <p>
        {SITE.name} runs on a small set of infrastructure providers — hosting, GPU compute, voice
      ...
      <ul>
        ...
        <li>Clearing browser storage removes everything {SITE.name} knows about you on that device.</li>
      </ul>
