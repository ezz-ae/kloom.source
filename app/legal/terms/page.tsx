...
export default function TermsPage() {
  return (
    <>
      ...
      <p>
        Kloom (&quot;Kloom&quot;, &quot;we&quot;, &quot;us&quot;) is a platform for voice and text conversations
        with AI characters in shared rooms. By creating a room, joining a room, or otherwise using
        Kloom, you agree to these terms.
      </p>

      <h2>1. What Kloom is</h2>
      <p>
        Every conversation on Kloom is with <strong>artificial intelligence</strong>. The characters are
      ...
      <ul>
        ...
        <li>Using Kloom to plan, enable, or facilitate real-world harm — violence, exploitation, fraud, or other crimes.</li>
      </ul>
      ...
      <p>
        Kloom is provided &quot;as is&quot;. AI output can be wrong, weird, or upsetting; synthesized
      ...
      <p>
        ...
        app. Continuing to use Kloom after a change means you accept it.
      </p>
    </>
  )
}
