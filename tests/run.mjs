...
const WHAT = {
  ...
  "claim-test":        "a paid pass is claimed, and a typed one is checked",
  ...
  "llm-answered-test":  "the reply says which model spoke",
  ...
  "ui-lang-test":       "the app language is a choice, and it is findable",
