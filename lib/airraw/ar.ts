...
export const AR: Record<string, string> = {
  ...
  "✦  your languages, everywhere": "✦  لغاتك، في كل حتة",
  "back to {name}": "ارجع لـ {name}",
  "app language": "لغة التطبيق",
  "App language": "لغة التطبيق",
  "the buttons and labels. your conversations follow the setting below.": "الأزرار والكلام. محادثاتك بتمشي على الإعداد اللي تحت.",
  "the floor fills with people who actually open in the languages you speak, instead of you finding them": "الفلور بيتملّى ناس بتبدأ الكلام باللغات اللي بتتكلمها، مش إنت اللي تدوّر عليهم",
  "your email — this is how you get back in": "إيميلك — ده اللي هترجع بيه",
  "How you get back in": "إزاي ترجع لاشتراكك",
  "on a new phone, either of these opens your pass.": "على أي موبايل جديد، أي واحدة من دول بتفتح اشتراكك.",
  "type it on any phone — no password. up to {n} devices.": "اكتبه في أي موبايل — من غير باسورد. لحد {n} أجهزة.",
  "copy my restore code": "انسخ كود الاسترجاع",
  "copied — keep it somewhere safe ✦": "اتنسخ — احفظه في مكان أمان ✦",
  "show the code": "اعرض الكود",
  "hide the code": "اخفي الكود",
  "your email": "إيميلك",
  "the email you paid with": "الإيميل اللي دفعت بيه",
  "open it with my email": "افتحه بالإيميل",
  "checking…": "بيتأكد…",
  "— or —": "— أو —",
  "that doesn't look like an email": "ده مش شكله إيميل",
  "no pass found on that email — check the address you paid with": "مفيش اشتراك على الإيميل ده — راجع العنوان اللي دفعت بيه",
  "this pass has already been opened on {n} devices": "الاشتراك ده اتفتح على {n} أجهزة خلاص",
  "can't check right now — try again in a moment": "مش قادر أتأكد دلوقتي — جرّب بعد شوية",
