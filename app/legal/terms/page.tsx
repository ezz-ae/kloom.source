...
export default function TermsPage() {
  return (
    <>
      ...
      <p>
        {SITE.name} (&quot;{SITE.name}&quot;, &quot;we&quot;, &quot;us&quot;) is a platform for voice and text conversations
        with AI characters in shared rooms. By creating a room, joining a room, or otherwise using
        {SITE.name}, you agree to these terms.
      </p>

      <h2>1. What {SITE.name} is</h2>
      <p>
        Every conversation on {SITE.name} is with <strong>artificial intelligence</strong>. The characters are
      ...
      <h2>2. Who can use {SITE.name}</h2>
      <ul>
        <li>You must be at least <strong>18 years old</strong> to use {SITE.name}. Period — not just for adult worlds.</li>
      ...
      <p>
        {SITE.name} runs open AI models with minimal content filtering. Adult, dark, and taboo fiction
      ...
      <ul>
        ...
        <li>Using {SITE.name} to plan, enable, or facilitate real-world harm — violence, exploitation, fraud, or other crimes.</li>
      </ul>
      ...
      <p>
        {SITE.name} is provided &quot;as is&quot;. AI output can be wrong, weird, or upsetting; synthesized
      ...
      <p>
        ...
        app. Continuing to use {SITE.name} after a change means you accept it.
      </p>
    </>
  )
}
